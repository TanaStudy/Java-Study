...
CREATE TABLE `pms_attr`  (
  ...
  `value_type` tinyint(0) NULL DEFAULT NULL COMMENT '0:只允许单个值，1:允许多个值',
...
) ENGINE = InnoDB AUTO_INCREMENT = 12 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '商品属性' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_attr
-- ----------------------------
INSERT INTO `pms_attr` VALUES (1, '入网型号', 0, 'mudedi', 'LIO-AN00m;A2108;以官网信息为准;V2001A', 0, 1, 1, 225, 0);
INSERT INTO `pms_attr` VALUES (2, '上市年份', 0, 'job', '2018;2019;2020', 0, 1, 1, 225, 0);
INSERT INTO `pms_attr` VALUES (3, '上市月份', 0, 'job', '3;5;6;12', 0, 1, 1, 225, 0);
INSERT INTO `pms_attr` VALUES (4, '机身长度（mm）', 0, 'log', '158.1mm;150.9mm;159.54mm;160.3mm;164.02mm', 0, 1, 1, 225, 0);
INSERT INTO `pms_attr` VALUES (5, '机身重量（g）', 0, 'sql', '198g;194g;192g;180g;174.5g', 0, 1, 1, 225, 0);
INSERT INTO `pms_attr` VALUES (6, '机身厚度（mm）', 0, 'tubiao', '8.8mm;8.3mm;7.96mm;7.49mm;7.88mm', 0, 1, 1, 225, 0);
INSERT INTO `pms_attr` VALUES (7, 'GPU型号', 1, 'shezhi', 'Mali G76;骁龙765G', 0, 1, 1, 225, 1);
INSERT INTO `pms_attr` VALUES (8, 'CPU品牌', 1, 'shezhi', '海思（Hisilicon）;以官网信息为准;高通(Qualcomm)', 0, 1, 1, 225, 1);
INSERT INTO `pms_attr` VALUES (9, '屏幕材质类型', 1, 'sousuo', 'OLED;LCD;AMOLED', 0, 1, 1, 225, 1);
INSERT INTO `pms_attr` VALUES (10, '屏幕刷新率', 1, 'mudedi', '60Hz;其他', 0, 1, 1, 225, 1);
INSERT INTO `pms_attr` VALUES (11, '颜色', 0, 'xiangqufill', '蓝色;红色;金色;白色;黑色;银色', 0, 0, 1, 225, 0);
INSERT INTO `pms_attr` VALUES (12, '内存', 0, 'shezhi', '6+64g;6+128g;8+128g;8+256g;6+256g', 0, 0, 1, 225, 0);
...
) ENGINE = InnoDB AUTO_INCREMENT = 11 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '属性&属性分组关联' ROW_FORMAT = Dynamic;
...
INSERT INTO `pms_attr_attrgroup_relation` VALUES (5, 5, 2, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (6, 6, 2, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (7, 7, 3, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (8, 8, 3, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (9, 9, 4, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (10, 10, 4, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (11, 3, 1, NULL);
...
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '属性分组' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_attr_group
-- ----------------------------
INSERT INTO `pms_attr_group` VALUES (1, '主体', 1, '品牌上市信息', 'shouye', 225);
INSERT INTO `pms_attr_group` VALUES (2, '基本信息', 2, '机身信息', 'system', 225);
INSERT INTO `pms_attr_group` VALUES (3, '主芯片', 3, 'GPU和CPU信息', 'shezhi', 225);
INSERT INTO `pms_attr_group` VALUES (4, '屏幕', 4, '屏幕信息', 'log', 225);
...
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '品牌' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_brand
-- ----------------------------
INSERT INTO `pms_brand` VALUES (1, '华为', 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/c999650a-a570-47b8-8dce-2c3f3d6a6063_huawei.png', '中华有为', 1, 'H', 1);
INSERT INTO `pms_brand` VALUES (2, '苹果', 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/17f72201-25e6-4472-88c6-8a184e73556e_apple.png', '从不卡顿', 1, 'A', 2);
INSERT INTO `pms_brand` VALUES (3, '小米', 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/8ec374a0-26b0-4401-8ab4-4158933b3633_xiaomi.png', '为发烧而生', 1, 'M', 2);
INSERT INTO `pms_brand` VALUES (4, 'OPPO', 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/6c64fb7e-ccb9-4271-88e9-12e5fe19156d_oppo.png', '充电5分钟，通话两小时', 1, 'O', 2);
INSERT INTO `pms_brand` VALUES (5, 'VIVO', 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/c74b28e2-bf3f-46ea-8002-245d9e0a1378_vivo.png', '拍出你的美', 1, 'V', 1);
...
CREATE TABLE `pms_category_brand_relation`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '品牌分类关联' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_category_brand_relation
-- ----------------------------
INSERT INTO `pms_category_brand_relation` VALUES (1, 1, 225, '华为', '手机');
INSERT INTO `pms_category_brand_relation` VALUES (2, 2, 225, '苹果', '手机');
INSERT INTO `pms_category_brand_relation` VALUES (3, 3, 225, '小米', '手机');
INSERT INTO `pms_category_brand_relation` VALUES (4, 5, 225, 'VIVO', '手机');
INSERT INTO `pms_category_brand_relation` VALUES (5, 4, 225, 'OPPO', '手机');
...
CREATE TABLE `pms_product_attr_value`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 70 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = 'spu属性值' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_product_attr_value
-- ----------------------------
INSERT INTO `pms_product_attr_value` VALUES (11, 3, 1, '入网型号', 'LIO-AN00m', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (12, 3, 2, '上市年份', '2020', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (13, 3, 3, '上市月份', '10', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (14, 3, 4, '机身长度（mm）', '158.1mm', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (15, 3, 5, '机身重量（g）', '198g', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (16, 3, 6, '机身厚度（mm）', '8.8mm', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (17, 3, 7, 'GPU型号', 'Mali G76', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (18, 3, 8, 'CPU品牌', '海思（Hisilicon）', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (19, 3, 9, '屏幕材质类型', 'OLED', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (20, 3, 10, '屏幕刷新率', '其他', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (21, 4, 1, '入网型号', 'A2108', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (22, 4, 2, '上市年份', '2018', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (23, 4, 3, '上市月份', '10', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (24, 4, 4, '机身长度（mm）', '150.9mm', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (25, 4, 5, '机身重量（g）', '194g', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (26, 4, 6, '机身厚度（mm）', '8.3mm', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (27, 4, 7, 'GPU型号', '以官网信息为准', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (28, 4, 8, 'CPU品牌', '以官网信息为准', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (29, 4, 9, '屏幕材质类型', 'LCD', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (30, 4, 10, '屏幕刷新率', '其他', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (31, 6, 7, 'GPU型号', '以官网信息为准', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (32, 6, 8, 'CPU品牌', '高通(Qualcomm)', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (33, 6, 4, '机身长度（mm）', '164.02mm', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (34, 6, 5, '机身重量（g）', '192g', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (35, 6, 6, '机身厚度（mm）', '7.88mm', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (36, 6, 1, '入网型号', '以官网信息为准', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (37, 6, 2, '上市年份', '2020', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (38, 6, 3, '上市月份', '4', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (39, 6, 9, '屏幕材质类型', 'AMOLED', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (40, 6, 10, '屏幕刷新率', '60Hz', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (51, 7, 1, '入网型号', 'V2001A', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (52, 7, 2, '上市年份', '2020', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (53, 7, 3, '上市月份', '6', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (54, 7, 4, '机身长度（mm）', '159.54mm', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (55, 7, 5, '机身重量（g）', '174.5g', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (56, 7, 6, '机身厚度（mm）', '7.49mm', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (57, 7, 7, 'GPU型号', '以官网信息为准', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (58, 7, 8, 'CPU品牌', '高通(Qualcomm)', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (59, 7, 9, '屏幕材质类型', 'AMOLED', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (60, 7, 10, '屏幕刷新率', '其他', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (61, 8, 1, '入网型号', '以官网信息为准', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (62, 8, 2, '上市年份', '2020', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (63, 8, 3, '上市月份', '8', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (64, 8, 4, '机身长度（mm）', '160.3mm', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (65, 8, 5, '机身重量（g）', '180g', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (66, 8, 6, '机身厚度（mm）', '7.96mm', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (67, 8, 7, 'GPU型号', '骁龙765G', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (68, 8, 8, 'CPU品牌', '高通(Qualcomm)', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (69, 8, 9, '屏幕材质类型', 'AMOLED', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (70, 8, 10, '屏幕刷新率', '60Hz', NULL, 1);
...
-- ----------------------------
INSERT INTO `pms_sku_images` VALUES (1, 1, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/2a2e991b-8684-4f5e-8d20-508861d2d3b2_3c24f9cd69534030 - 副本.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (2, 1, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/ab88242e-e16a-4ba0-84f3-1b96c81e2483_23d9fbb256ea5d4a - 副本.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (3, 1, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/9501feff-cf63-4741-8ca4-4a796a6cfbce_a83bf5250e14caf2 - 副本.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (4, 1, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/fc5a3c57-0745-49bf-8027-ab3c78807a16_b5c6b23d01dcdf81.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (5, 2, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/2a2e991b-8684-4f5e-8d20-508861d2d3b2_3c24f9cd69534030 - 副本.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (6, 2, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/ab88242e-e16a-4ba0-84f3-1b96c81e2483_23d9fbb256ea5d4a - 副本.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (7, 2, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/9501feff-cf63-4741-8ca4-4a796a6cfbce_a83bf5250e14caf2 - 副本.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (8, 2, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/fc5a3c57-0745-49bf-8027-ab3c78807a16_b5c6b23d01dcdf81.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (9, 3, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/8fd16570-d701-4a61-8f58-3c2b7b1d57fb_8bf441260bffa42f.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (10, 3, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/33f99be1-957d-4d0e-8b42-7adbbff1332e_2b1837c6c50add30 - 副本.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (11, 3, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/9cdd490e-b192-41b1-8bdd-bfab4b04113e_28f296629cca865e - 副本.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (12, 3, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/ced6b094-532c-4c12-8c1c-20a9ed7a6bb2_335b2c690e43a8f8 - 副本.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (13, 4, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/8fd16570-d701-4a61-8f58-3c2b7b1d57fb_8bf441260bffa42f.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (14, 4, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/9cdd490e-b192-41b1-8bdd-bfab4b04113e_28f296629cca865e - 副本.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (15, 4, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/ced6b094-532c-4c12-8c1c-20a9ed7a6bb2_335b2c690e43a8f8 - 副本.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (16, 5, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/4d5cfa43-7734-4c6c-8916-1eef20889468_73ab4d2e818d2211.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (17, 5, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/86777e29-eccd-483d-8d62-c0f1faa6c622_919c850652e98031 - 副本.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (18, 5, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/14fc4455-95b7-43fc-8400-6d939bce92e6_b9840ff8da7762ae.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (19, 5, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/57c8e0f3-b570-4e20-8af7-c689ae813fd7_d511faab82abb34b.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (20, 6, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/4d5cfa43-7734-4c6c-8916-1eef20889468_73ab4d2e818d2211.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (21, 6, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/86777e29-eccd-483d-8d62-c0f1faa6c622_919c850652e98031 - 副本.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (22, 6, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/14fc4455-95b7-43fc-8400-6d939bce92e6_b9840ff8da7762ae.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (23, 6, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/57c8e0f3-b570-4e20-8af7-c689ae813fd7_d511faab82abb34b.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (24, 7, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/b836a146-46c7-4d02-8201-f154f36f584f_6a1b2703a9ed8737.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (25, 7, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/571335f0-73d0-4544-88d1-a9ecc4bc054b_ccd1077b985c7150.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (26, 7, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/7e9277f5-db02-40f9-8be2-b3f226ae4bef_shkacnalcl.png', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (27, 8, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/b836a146-46c7-4d02-8201-f154f36f584f_6a1b2703a9ed8737.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (28, 8, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/571335f0-73d0-4544-88d1-a9ecc4bc054b_ccd1077b985c7150.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (29, 8, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/7e9277f5-db02-40f9-8be2-b3f226ae4bef_shkacnalcl.png', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (30, 9, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/3ac0996a-850d-48e2-81fd-614b62b1a742_chns28dh2.png', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (31, 9, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/eca929c4-8608-49f2-80c1-d760a34da35b_hd2fcnwosm.png', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (32, 9, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/7e9277f5-db02-40f9-8be2-b3f226ae4bef_shkacnalcl.png', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (33, 10, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/3ac0996a-850d-48e2-81fd-614b62b1a742_chns28dh2.png', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (34, 10, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/eca929c4-8608-49f2-80c1-d760a34da35b_hd2fcnwosm.png', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (35, 10, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/7e9277f5-db02-40f9-8be2-b3f226ae4bef_shkacnalcl.png', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (36, 11, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/ea46d643-2991-4fa6-8842-501dad257291_a2c208410ae84d1f.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (37, 11, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/cdd785e2-11df-4cb8-81f6-5c7acd0409c6_b8494bf281991f94.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (38, 11, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/7e9277f5-db02-40f9-8be2-b3f226ae4bef_shkacnalcl.png', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (39, 12, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/ea46d643-2991-4fa6-8842-501dad257291_a2c208410ae84d1f.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (40, 12, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/cdd785e2-11df-4cb8-81f6-5c7acd0409c6_b8494bf281991f94.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (41, 12, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/7e9277f5-db02-40f9-8be2-b3f226ae4bef_shkacnalcl.png', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (42, 13, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2020-10-28/329dd2a1-4399-46f4-8f73-1490c3a554eb_2r4hytkfgfd.png', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (43, 13, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2020-10-28/d8d22666-eb60-4109-8ca7-d19628ad5109_fwqeftgewagq45 ht.png', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (44, 13, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2020-10-28/2bca7ab0-4661-478c-8934-43d17a4bbfb6_REYT356U JRHS.png', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (45, 13, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2020-10-28/36969090-ddf7-4ab2-840c-dfb8cb410a23_TEWTWESFD.png', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (46, 13, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2020-10-28/3a1ac4a3-84b1-4768-8daa-9b403c40be2f_qty43gesdf.png', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (47, 14, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2020-10-28/329dd2a1-4399-46f4-8f73-1490c3a554eb_2r4hytkfgfd.png', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (48, 14, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2020-10-28/d8d22666-eb60-4109-8ca7-d19628ad5109_fwqeftgewagq45 ht.png', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (49, 14, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2020-10-28/2bca7ab0-4661-478c-8934-43d17a4bbfb6_REYT356U JRHS.png', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (50, 14, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2020-10-28/36969090-ddf7-4ab2-840c-dfb8cb410a23_TEWTWESFD.png', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (51, 14, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2020-10-28/3a1ac4a3-84b1-4768-8daa-9b403c40be2f_qty43gesdf.png', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (52, 15, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2020-10-28/9e750a04-f061-462f-8be0-495fc3251c69_]1O3RF$Q{5QF7{}9C4VS}80.png', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (53, 15, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2020-10-28/d2302622-4320-4cb2-8d75-5fd73dea37b4_~~(O[EXXL2ZP[O0A3LD6_05.png', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (54, 15, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2020-10-28/14a9f576-f3fd-4c48-8b37-419fb569afd8_34gv2ytvb3t4qy4.png', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (55, 15, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2020-10-28/a6509001-80e5-4570-8932-e3a05c6b3453_3fwe.png', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (56, 16, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2020-10-28/9e750a04-f061-462f-8be0-495fc3251c69_]1O3RF$Q{5QF7{}9C4VS}80.png', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (57, 16, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2020-10-28/d2302622-4320-4cb2-8d75-5fd73dea37b4_~~(O[EXXL2ZP[O0A3LD6_05.png', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (58, 16, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2020-10-28/14a9f576-f3fd-4c48-8b37-419fb569afd8_34gv2ytvb3t4qy4.png', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (59, 16, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2020-10-28/a6509001-80e5-4570-8932-e3a05c6b3453_3fwe.png', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (60, 17, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2020-10-28/2bbf6581-b800-489d-8ef9-e9ad4d7a4a7e_FSFSAFASFAS.png', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (61, 17, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2020-10-28/37c7912b-cb4f-4621-81d8-cab01d28a340_TQEWTWEDSDG.png', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (62, 17, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2020-10-28/54bf4fa5-d525-4d9e-82cb-4cb4fa5c8644_t43v26tvg425yq.png', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (63, 18, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2020-10-28/2bbf6581-b800-489d-8ef9-e9ad4d7a4a7e_FSFSAFASFAS.png', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (64, 18, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2020-10-28/37c7912b-cb4f-4621-81d8-cab01d28a340_TQEWTWEDSDG.png', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (65, 18, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2020-10-28/54bf4fa5-d525-4d9e-82cb-4cb4fa5c8644_t43v26tvg425yq.png', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (66, 19, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2020-10-28/f2f2f737-3ccb-4346-842b-8a68d5bf2a6c_Snipaste_2020-10-28_13-43-42.png', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (67, 19, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2020-10-28/ea7c956e-fb3a-4f00-8faa-c014e151ea6d_Snipaste_2020-10-28_13-43-51.png', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (68, 19, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2020-10-28/87c479ca-da4e-4eed-8756-f621ada0b4c3_Snipaste_2020-10-28_13-44-09.png', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (69, 19, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2020-10-28/f4c7ac96-2130-4483-8140-90566b9d61e5_Snipaste_2020-10-28_13-44-01.png', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (70, 20, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2020-10-28/f2f2f737-3ccb-4346-842b-8a68d5bf2a6c_Snipaste_2020-10-28_13-43-42.png', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (71, 20, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2020-10-28/87c479ca-da4e-4eed-8756-f621ada0b4c3_Snipaste_2020-10-28_13-44-09.png', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (72, 20, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2020-10-28/f4c7ac96-2130-4483-8140-90566b9d61e5_Snipaste_2020-10-28_13-44-01.png', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (73, 21, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2020-10-28/4a9391e8-01ee-4ad7-8b27-0fe473a4d766_Snipaste_2020-10-28_13-41-55.png', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (74, 21, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2020-10-28/5a163313-5934-4cbe-80ed-6cf31f1e81a7_Snipaste_2020-10-28_13-42-41.png', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (75, 21, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2020-10-28/cd3d3b53-5013-4753-8cd1-f387df164fad_Snipaste_2020-10-28_13-42-54.png', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (76, 21, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2020-10-28/abd76a64-139f-4187-84f2-68303242e681_Snipaste_2020-10-28_13-43-18.png', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (77, 21, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2020-10-28/db4e2787-2941-4f10-89ba-604e4e497043_Snipaste_2020-10-28_13-43-07.png', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (78, 22, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2020-10-28/4a9391e8-01ee-4ad7-8b27-0fe473a4d766_Snipaste_2020-10-28_13-41-55.png', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (79, 22, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2020-10-28/5a163313-5934-4cbe-80ed-6cf31f1e81a7_Snipaste_2020-10-28_13-42-41.png', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (80, 22, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2020-10-28/cd3d3b53-5013-4753-8cd1-f387df164fad_Snipaste_2020-10-28_13-42-54.png', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (81, 22, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2020-10-28/abd76a64-139f-4187-84f2-68303242e681_Snipaste_2020-10-28_13-43-18.png', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (82, 22, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2020-10-28/db4e2787-2941-4f10-89ba-604e4e497043_Snipaste_2020-10-28_13-43-07.png', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (83, 23, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2020-10-28/635df4b7-f9d6-48e2-8951-3a2213ece168_Snipaste_2020-10-28_13-44-38.png', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (84, 23, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2020-10-28/489f0eaf-3289-45ea-8cfa-a8f5e1874a59_Snipaste_2020-10-28_13-44-30.png', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (85, 23, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2020-10-28/168ed1ea-b67a-4077-8fa9-2859208559bb_Snipaste_2020-10-28_13-44-45.png', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (86, 23, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2020-10-28/1882e3ef-1419-4966-8c24-ee4f5b7edf9a_Snipaste_2020-10-28_13-45-04.png', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (87, 23, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2020-10-28/2352aa12-dbde-441a-86c8-0ebe30cd25d1_Snipaste_2020-10-28_13-44-55.png', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (88, 24, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2020-10-28/635df4b7-f9d6-48e2-8951-3a2213ece168_Snipaste_2020-10-28_13-44-38.png', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (89, 24, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2020-10-28/489f0eaf-3289-45ea-8cfa-a8f5e1874a59_Snipaste_2020-10-28_13-44-30.png', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (90, 24, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2020-10-28/168ed1ea-b67a-4077-8fa9-2859208559bb_Snipaste_2020-10-28_13-44-45.png', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (91, 24, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2020-10-28/1882e3ef-1419-4966-8c24-ee4f5b7edf9a_Snipaste_2020-10-28_13-45-04.png', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (92, 24, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2020-10-28/2352aa12-dbde-441a-86c8-0ebe30cd25d1_Snipaste_2020-10-28_13-44-55.png', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (93, 25, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/eb4e30bc-255b-473c-8c6f-6e4feafdac8e_AWERWARFA.png', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (94, 25, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/b7a93d66-df4b-45cf-856b-1bae99d35bff_345tgers bdgfgase.png', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (95, 25, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/344764fe-63b4-4f90-8b86-2890e21842e0_h531qtg4.png', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (96, 26, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/eb4e30bc-255b-473c-8c6f-6e4feafdac8e_AWERWARFA.png', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (97, 26, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/b7a93d66-df4b-45cf-856b-1bae99d35bff_345tgers bdgfgase.png', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (98, 26, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/344764fe-63b4-4f90-8b86-2890e21842e0_h531qtg4.png', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (99, 26, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/7ea762a8-27d7-418f-8cf4-ea5fc795dec5_TEWQQWAFG RGHD.png', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (100, 27, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/fd5b620c-7dde-4cf2-8ff9-e451ae16b613_8v43u9v93v.png', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (101, 27, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/1f20ab91-d033-4846-8295-4fb74ccef0c2_YYTRTAFSD.png', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (102, 27, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/74204123-3709-4c7a-86e8-e6c72a866a53_d9suds8dh8s.png', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (103, 28, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/fd5b620c-7dde-4cf2-8ff9-e451ae16b613_8v43u9v93v.png', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (104, 28, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/1f20ab91-d033-4846-8295-4fb74ccef0c2_YYTRTAFSD.png', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (105, 28, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/74204123-3709-4c7a-86e8-e6c72a866a53_d9suds8dh8s.png', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (106, 29, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/8f490a3b-894f-4cf0-8429-c61a5c51364f_3rteewagfvsa.png', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (107, 29, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/0b9eef68-535e-4beb-825d-3d19aeca3ca7_FASFWASAFEWRT.png', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (108, 29, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/8080d1a0-41dd-430e-8742-9ba5064b6f08_fgewt3456yb 45.png', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (109, 30, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/8f490a3b-894f-4cf0-8429-c61a5c51364f_3rteewagfvsa.png', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (110, 30, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/0b9eef68-535e-4beb-825d-3d19aeca3ca7_FASFWASAFEWRT.png', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (111, 30, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/8080d1a0-41dd-430e-8742-9ba5064b6f08_fgewt3456yb 45.png', NULL, 0);
...
) ENGINE = InnoDB AUTO_INCREMENT = 30 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = 'sku信息' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_sku_info
-- ----------------------------
INSERT INTO `pms_sku_info` VALUES (1, 3, '华为 HUAWEI Mate 30E Pro 5G 翡翠冷 8+128g', '翡翠冷,8+128g', 225, 1, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/9501feff-cf63-4741-8ca4-4a796a6cfbce_a83bf5250e14caf2 - 副本.jpg', '华为 HUAWEI Mate 30E Pro 5G 翡翠冷 8+128g 麒麟990E SoC芯片 双4000万徕卡电影影像 全网通手机', '至高6期免息，88°超曲面环幕屏,双4000万徕卡电影影像；华为手机全场至高6期免息', 5299.0000, 0);
INSERT INTO `pms_sku_info` VALUES (2, 3, '华为 HUAWEI Mate 30E Pro 5G 翡翠冷 8+256g', '翡翠冷,8+256g', 225, 1, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/9501feff-cf63-4741-8ca4-4a796a6cfbce_a83bf5250e14caf2 - 副本.jpg', '华为 HUAWEI Mate 30E Pro 5G 翡翠冷 8+256g 麒麟990E SoC芯片 双4000万徕卡电影影像 全网通手机', '至高6期免息，88°超曲面环幕屏,双4000万徕卡电影影像；华为手机全场至高6期免息', 5799.0000, 0);
INSERT INTO `pms_sku_info` VALUES (3, 3, '华为 HUAWEI Mate 30E Pro 5G 亮黑色 8+128g', '亮黑色,8+128g', 225, 1, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/8fd16570-d701-4a61-8f58-3c2b7b1d57fb_8bf441260bffa42f.jpg', '华为 HUAWEI Mate 30E Pro 5G 亮黑色 8+128g 麒麟990E SoC芯片 双4000万徕卡电影影像 全网通手机', '至高6期免息，88°超曲面环幕屏,双4000万徕卡电影影像；华为手机全场至高6期免息', 5299.0000, 0);
INSERT INTO `pms_sku_info` VALUES (4, 3, '华为 HUAWEI Mate 30E Pro 5G 亮黑色 8+256g', '亮黑色,8+256g', 225, 1, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/8fd16570-d701-4a61-8f58-3c2b7b1d57fb_8bf441260bffa42f.jpg', '华为 HUAWEI Mate 30E Pro 5G 亮黑色 8+256g 麒麟990E SoC芯片 双4000万徕卡电影影像 全网通手机', '至高6期免息，88°超曲面环幕屏,双4000万徕卡电影影像；华为手机全场至高6期免息', 5799.0000, 0);
INSERT INTO `pms_sku_info` VALUES (5, 3, '华为 HUAWEI Mate 30E Pro 5G 星河银 8+128g', '星河银,8+128g', 225, 1, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/57c8e0f3-b570-4e20-8af7-c689ae813fd7_d511faab82abb34b.jpg', '华为 HUAWEI Mate 30E Pro 5G 星河银 8+128g 麒麟990E SoC芯片 双4000万徕卡电影影像 全网通手机', '至高6期免息，88°超曲面环幕屏,双4000万徕卡电影影像；华为手机全场至高6期免息', 5299.0000, 0);
INSERT INTO `pms_sku_info` VALUES (6, 3, '华为 HUAWEI Mate 30E Pro 5G 星河银 8+256g', '星河银,8+256g', 225, 1, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/57c8e0f3-b570-4e20-8af7-c689ae813fd7_d511faab82abb34b.jpg', '华为 HUAWEI Mate 30E Pro 5G 星河银 8+256g 麒麟990E SoC芯片 双4000万徕卡电影影像 全网通手机', '至高6期免息，88°超曲面环幕屏,双4000万徕卡电影影像；华为手机全场至高6期免息', 5799.0000, 0);
INSERT INTO `pms_sku_info` VALUES (7, 4, 'Apple iPhone XR (A2108)  红色 64g', '红色,64g', 225, 2, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/571335f0-73d0-4544-88d1-a9ecc4bc054b_ccd1077b985c7150.jpg', 'Apple iPhone XR (A2108)  红色 64g 移动联通电信4G手机 双卡双待', '移动联通电信4G手机 双卡双待', 3999.0000, 0);
INSERT INTO `pms_sku_info` VALUES (8, 4, 'Apple iPhone XR (A2108)  红色 128g', '红色,128g', 225, 2, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/571335f0-73d0-4544-88d1-a9ecc4bc054b_ccd1077b985c7150.jpg', 'Apple iPhone XR (A2108)  红色 128g 移动联通电信4G手机 双卡双待', '移动联通电信4G手机 双卡双待', 4499.0000, 0);
INSERT INTO `pms_sku_info` VALUES (9, 4, 'Apple iPhone XR (A2108)  蓝色 64g', '蓝色,64g', 225, 2, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/eca929c4-8608-49f2-80c1-d760a34da35b_hd2fcnwosm.png', 'Apple iPhone XR (A2108)  蓝色 64g 移动联通电信4G手机 双卡双待', '移动联通电信4G手机 双卡双待', 3999.0000, 0);
INSERT INTO `pms_sku_info` VALUES (10, 4, 'Apple iPhone XR (A2108)  蓝色 128g', '蓝色,128g', 225, 2, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/eca929c4-8608-49f2-80c1-d760a34da35b_hd2fcnwosm.png', 'Apple iPhone XR (A2108)  蓝色 128g 移动联通电信4G手机 双卡双待', '移动联通电信4G手机 双卡双待', 4499.0000, 0);
INSERT INTO `pms_sku_info` VALUES (11, 4, 'Apple iPhone XR (A2108)  黑色 64g', '黑色,64g', 225, 2, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/ea46d643-2991-4fa6-8842-501dad257291_a2c208410ae84d1f.jpg', 'Apple iPhone XR (A2108)  黑色 64g 移动联通电信4G手机 双卡双待', '移动联通电信4G手机 双卡双待', 3999.0000, 0);
INSERT INTO `pms_sku_info` VALUES (12, 4, 'Apple iPhone XR (A2108)  黑色 128g', '黑色,128g', 225, 2, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/ea46d643-2991-4fa6-8842-501dad257291_a2c208410ae84d1f.jpg', 'Apple iPhone XR (A2108)  黑色 128g 移动联通电信4G手机 双卡双待', '移动联通电信4G手机 双卡双待', 4499.0000, 0);
INSERT INTO `pms_sku_info` VALUES (13, 6, '【向往的生活同款】小米10青春版  白桃乌龙 8g+128g', '白桃乌龙,8g+128g', 225, 3, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2020-10-28/2bca7ab0-4661-478c-8934-43d17a4bbfb6_REYT356U JRHS.png', '【向往的生活同款】小米10青春版  白桃乌龙 8g+128g双模5G 骁龙765G 50倍潜望式变焦四摄 8GB+128GB 黑巧风暴游戏手机', '限时特惠，尊享白条6期免息，现货速发【小米10限时预售中!点此直达】查看>', 2199.0000, 0);
INSERT INTO `pms_sku_info` VALUES (14, 6, '【向往的生活同款】小米10青春版  白桃乌龙 8g+256g', '白桃乌龙,8g+256g', 225, 3, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2020-10-28/3a1ac4a3-84b1-4768-8daa-9b403c40be2f_qty43gesdf.png', '【向往的生活同款】小米10青春版  白桃乌龙 8g+256g双模5G 骁龙765G 50倍潜望式变焦四摄 8GB+128GB 黑巧风暴游戏手机', '限时特惠，尊享白条6期免息，现货速发【小米10限时预售中!点此直达】查看>', 2499.0000, 0);
INSERT INTO `pms_sku_info` VALUES (15, 6, '【向往的生活同款】小米10青春版  蓝莓薄荷 8g+128g', '蓝莓薄荷,8g+128g', 225, 3, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2020-10-28/d2302622-4320-4cb2-8d75-5fd73dea37b4_~~(O[EXXL2ZP[O0A3LD6_05.png', '【向往的生活同款】小米10青春版  蓝莓薄荷 8g+128g双模5G 骁龙765G 50倍潜望式变焦四摄 8GB+128GB 黑巧风暴游戏手机', '限时特惠，尊享白条6期免息，现货速发【小米10限时预售中!点此直达】查看>', 2199.0000, 0);
INSERT INTO `pms_sku_info` VALUES (16, 6, '【向往的生活同款】小米10青春版  蓝莓薄荷 8g+256g', '蓝莓薄荷,8g+256g', 225, 3, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2020-10-28/d2302622-4320-4cb2-8d75-5fd73dea37b4_~~(O[EXXL2ZP[O0A3LD6_05.png', '【向往的生活同款】小米10青春版  蓝莓薄荷 8g+256g双模5G 骁龙765G 50倍潜望式变焦四摄 8GB+128GB 黑巧风暴游戏手机', '限时特惠，尊享白条6期免息，现货速发【小米10限时预售中!点此直达】查看>', 2499.0000, 0);
INSERT INTO `pms_sku_info` VALUES (17, 6, '【向往的生活同款】小米10青春版  黑巧风暴 8g+128g', '黑巧风暴,8g+128g', 225, 3, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2020-10-28/37c7912b-cb4f-4621-81d8-cab01d28a340_TQEWTWEDSDG.png', '【向往的生活同款】小米10青春版  黑巧风暴 8g+128g双模5G 骁龙765G 50倍潜望式变焦四摄 8GB+128GB 黑巧风暴游戏手机', '限时特惠，尊享白条6期免息，现货速发【小米10限时预售中!点此直达】查看>', 2199.0000, 0);
INSERT INTO `pms_sku_info` VALUES (18, 6, '【向往的生活同款】小米10青春版  黑巧风暴 8g+256g', '黑巧风暴,8g+256g', 225, 3, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2020-10-28/37c7912b-cb4f-4621-81d8-cab01d28a340_TQEWTWEDSDG.png', '【向往的生活同款】小米10青春版  黑巧风暴 8g+256g双模5G 骁龙765G 50倍潜望式变焦四摄 8GB+128GB 黑巧风暴游戏手机', '限时特惠，尊享白条6期免息，现货速发【小米10限时预售中!点此直达】查看>', 2499.0000, 0);
INSERT INTO `pms_sku_info` VALUES (19, 7, 'vivo X50 5G手机 液氧 8g+128g', '液氧,8g+128g', 225, 5, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2020-10-28/f2f2f737-3ccb-4346-842b-8a68d5bf2a6c_Snipaste_2020-10-28_13-43-42.png', 'vivo X50 5G手机 液氧 8g+128g20倍变焦 超感光夜摄 90Hz超薄柔性屏 双模5G全网通手机', '【11月1日特惠100，到手价3598，24期免息赠半年延保】现货预售APP端专享，且需更新至V9.2.0版本，iQOO5预定至高省400》查看>', 3298.0000, 0);
INSERT INTO `pms_sku_info` VALUES (20, 7, 'vivo X50 5G手机 液氧 8g+256g', '液氧,8g+256g', 225, 5, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2020-10-28/f2f2f737-3ccb-4346-842b-8a68d5bf2a6c_Snipaste_2020-10-28_13-43-42.png', 'vivo X50 5G手机 液氧 8g+256g20倍变焦 超感光夜摄 90Hz超薄柔性屏 双模5G全网通手机', '【11月1日特惠100，到手价3598，24期免息赠半年延保】现货预售APP端专享，且需更新至V9.2.0版本，iQOO5预定至高省400》查看>', 3698.0000, 0);
INSERT INTO `pms_sku_info` VALUES (21, 7, 'vivo X50 5G手机 黑镜 8g+128g', '黑镜,8g+128g', 225, 5, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2020-10-28/4a9391e8-01ee-4ad7-8b27-0fe473a4d766_Snipaste_2020-10-28_13-41-55.png', 'vivo X50 5G手机 黑镜 8g+128g20倍变焦 超感光夜摄 90Hz超薄柔性屏 双模5G全网通手机', '【11月1日特惠100，到手价3598，24期免息赠半年延保】现货预售APP端专享，且需更新至V9.2.0版本，iQOO5预定至高省400》查看>', 3298.0000, 0);
INSERT INTO `pms_sku_info` VALUES (22, 7, 'vivo X50 5G手机 黑镜 8g+256g', '黑镜,8g+256g', 225, 5, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2020-10-28/4a9391e8-01ee-4ad7-8b27-0fe473a4d766_Snipaste_2020-10-28_13-41-55.png', 'vivo X50 5G手机 黑镜 8g+256g20倍变焦 超感光夜摄 90Hz超薄柔性屏 双模5G全网通手机', '【11月1日特惠100，到手价3598，24期免息赠半年延保】现货预售APP端专享，且需更新至V9.2.0版本，iQOO5预定至高省400》查看>', 3698.0000, 0);
INSERT INTO `pms_sku_info` VALUES (23, 7, 'vivo X50 5G手机 浅熏 8g+128g', '浅熏,8g+128g', 225, 5, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2020-10-28/489f0eaf-3289-45ea-8cfa-a8f5e1874a59_Snipaste_2020-10-28_13-44-30.png', 'vivo X50 5G手机 浅熏 8g+128g20倍变焦 超感光夜摄 90Hz超薄柔性屏 双模5G全网通手机', '【11月1日特惠100，到手价3598，24期免息赠半年延保】现货预售APP端专享，且需更新至V9.2.0版本，iQOO5预定至高省400》查看>', 3298.0000, 0);
INSERT INTO `pms_sku_info` VALUES (24, 7, 'vivo X50 5G手机 浅熏 8g+256g', '浅熏,8g+256g', 225, 5, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2020-10-28/489f0eaf-3289-45ea-8cfa-a8f5e1874a59_Snipaste_2020-10-28_13-44-30.png', 'vivo X50 5G手机 浅熏 8g+256g20倍变焦 超感光夜摄 90Hz超薄柔性屏 双模5G全网通手机', '【11月1日特惠100，到手价3598，24期免息赠半年延保】现货预售APP端专享，且需更新至V9.2.0版本，iQOO5预定至高省400》查看>', 3698.0000, 0);
INSERT INTO `pms_sku_info` VALUES (25, 8, 'OPPO K7 双模5G 骁龙765G 流云 8+128g', '流云,8+128g', 225, 4, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/344764fe-63b4-4f90-8b86-2890e21842e0_h531qtg4.png', 'OPPO K7 双模5G 骁龙765G 流云 8+128g 30W VOOC闪充 石墨片+铜管散热 游戏电竞手机', '【1.9-10限时到手价1899元】OLED屏幕指纹，4800万超清四摄，3200万前摄【OPPOA53新品限时送耳机】', 1899.0000, 0);
INSERT INTO `pms_sku_info` VALUES (26, 8, 'OPPO K7 双模5G 骁龙765G 流云 8+256g', '流云,8+256g', 225, 4, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/b7a93d66-df4b-45cf-856b-1bae99d35bff_345tgers bdgfgase.png', 'OPPO K7 双模5G 骁龙765G 流云 8+256g 30W VOOC闪充 石墨片+铜管散热 游戏电竞手机', '【1.9-10限时到手价1899元】OLED屏幕指纹，4800万超清四摄，3200万前摄【OPPOA53新品限时送耳机】', 2199.0000, 0);
INSERT INTO `pms_sku_info` VALUES (27, 8, 'OPPO K7 双模5G 骁龙765G 秘境 8+128g', '秘境,8+128g', 225, 4, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/74204123-3709-4c7a-86e8-e6c72a866a53_d9suds8dh8s.png', 'OPPO K7 双模5G 骁龙765G 秘境 8+128g 30W VOOC闪充 石墨片+铜管散热 游戏电竞手机', '【1.9-10限时到手价1899元】OLED屏幕指纹，4800万超清四摄，3200万前摄【OPPOA53新品限时送耳机】', 1899.0000, 0);
INSERT INTO `pms_sku_info` VALUES (28, 8, 'OPPO K7 双模5G 骁龙765G 秘境 8+256g', '秘境,8+256g', 225, 4, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/74204123-3709-4c7a-86e8-e6c72a866a53_d9suds8dh8s.png', 'OPPO K7 双模5G 骁龙765G 秘境 8+256g 30W VOOC闪充 石墨片+铜管散热 游戏电竞手机', '【1.9-10限时到手价1899元】OLED屏幕指纹，4800万超清四摄，3200万前摄【OPPOA53新品限时送耳机】', 2199.0000, 0);
INSERT INTO `pms_sku_info` VALUES (29, 8, 'OPPO K7 双模5G 骁龙765G 海夜 8+128g', '海夜,8+128g', 225, 4, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/8f490a3b-894f-4cf0-8429-c61a5c51364f_3rteewagfvsa.png', 'OPPO K7 双模5G 骁龙765G 海夜 8+128g 30W VOOC闪充 石墨片+铜管散热 游戏电竞手机', '【1.9-10限时到手价1899元】OLED屏幕指纹，4800万超清四摄，3200万前摄【OPPOA53新品限时送耳机】', 1899.0000, 0);
INSERT INTO `pms_sku_info` VALUES (30, 8, 'OPPO K7 双模5G 骁龙765G 海夜 8+256g', '海夜,8+256g', 225, 4, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/8f490a3b-894f-4cf0-8429-c61a5c51364f_3rteewagfvsa.png', 'OPPO K7 双模5G 骁龙765G 海夜 8+256g 30W VOOC闪充 石墨片+铜管散热 游戏电竞手机', '【1.9-10限时到手价1899元】OLED屏幕指纹，4800万超清四摄，3200万前摄【OPPOA53新品限时送耳机】', 2199.0000, 0);
...
CREATE TABLE `pms_sku_sale_attr_value`  (
  ...
  `attr_sort` int(0) NULL DEFAULT NULL COMMENT '顺序',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 60 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = 'sku销售属性&值' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_sku_sale_attr_value
-- ----------------------------
INSERT INTO `pms_sku_sale_attr_value` VALUES (1, 1, 11, '颜色', '翡翠冷', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (2, 1, 12, '内存', '8+128g', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (3, 2, 11, '颜色', '翡翠冷', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (4, 2, 12, '内存', '8+256g', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (5, 3, 11, '颜色', '亮黑色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (6, 3, 12, '内存', '8+128g', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (7, 4, 11, '颜色', '亮黑色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (8, 4, 12, '内存', '8+256g', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (9, 5, 11, '颜色', '星河银', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (10, 5, 12, '内存', '8+128g', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (11, 6, 11, '颜色', '星河银', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (12, 6, 12, '内存', '8+256g', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (13, 7, 11, '颜色', '红色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (14, 7, 12, '内存', '64g', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (15, 8, 11, '颜色', '红色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (16, 8, 12, '内存', '128g', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (17, 9, 11, '颜色', '蓝色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (18, 9, 12, '内存', '64g', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (19, 10, 11, '颜色', '蓝色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (20, 10, 12, '内存', '128g', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (21, 11, 11, '颜色', '黑色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (22, 11, 12, '内存', '64g', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (23, 12, 11, '颜色', '黑色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (24, 12, 12, '内存', '128g', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (25, 13, 11, '颜色', '白桃乌龙', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (26, 13, 12, '版本', '8g+128g', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (27, 14, 11, '颜色', '白桃乌龙', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (28, 14, 12, '版本', '8g+256g', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (29, 15, 11, '颜色', '蓝莓薄荷', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (30, 15, 12, '版本', '8g+128g', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (31, 16, 11, '颜色', '蓝莓薄荷', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (32, 16, 12, '版本', '8g+256g', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (33, 17, 11, '颜色', '黑巧风暴', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (34, 17, 12, '版本', '8g+128g', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (35, 18, 11, '颜色', '黑巧风暴', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (36, 18, 12, '版本', '8g+256g', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (37, 19, 11, '颜色', '液氧', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (38, 19, 12, '版本', '8g+128g', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (39, 20, 11, '颜色', '液氧', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (40, 20, 12, '版本', '8g+256g', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (41, 21, 11, '颜色', '黑镜', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (42, 21, 12, '版本', '8g+128g', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (43, 22, 11, '颜色', '黑镜', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (44, 22, 12, '版本', '8g+256g', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (45, 23, 11, '颜色', '浅熏', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (46, 23, 12, '版本', '8g+128g', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (47, 24, 11, '颜色', '浅熏', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (48, 24, 12, '版本', '8g+256g', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (49, 25, 11, '颜色', '流云', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (50, 25, 12, '内存', '8+128g', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (51, 26, 11, '颜色', '流云', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (52, 26, 12, '内存', '8+256g', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (53, 27, 11, '颜色', '秘境', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (54, 27, 12, '内存', '8+128g', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (55, 28, 11, '颜色', '秘境', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (56, 28, 12, '内存', '8+256g', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (57, 29, 11, '颜色', '海夜', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (58, 29, 12, '内存', '8+128g', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (59, 30, 11, '颜色', '海夜', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (60, 30, 12, '内存', '8+256g', NULL);
...
CREATE TABLE `pms_spu_images`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 91 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = 'spu图片' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_spu_images
-- ----------------------------
INSERT INTO `pms_spu_images` VALUES (19, 3, NULL, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/a4cfde16-e5da-4942-8a69-9c04c4997436_1f15cdbcf9e1273c - 副本.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (20, 3, NULL, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/2a2e991b-8684-4f5e-8d20-508861d2d3b2_3c24f9cd69534030 - 副本.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (21, 3, NULL, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/8fd16570-d701-4a61-8f58-3c2b7b1d57fb_8bf441260bffa42f.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (22, 3, NULL, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/80a969f1-18a3-4b0d-8a27-cd5b8c1474d9_8bf441260bffa42f - 副本.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (23, 3, NULL, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/33f99be1-957d-4d0e-8b42-7adbbff1332e_2b1837c6c50add30 - 副本.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (24, 3, NULL, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/ab88242e-e16a-4ba0-84f3-1b96c81e2483_23d9fbb256ea5d4a - 副本.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (25, 3, NULL, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/63378902-6f11-4e5e-8fed-7f4e3bcd326b_73366cc235d68202 - 副本.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (26, 3, NULL, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/4d5cfa43-7734-4c6c-8916-1eef20889468_73ab4d2e818d2211.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (27, 3, NULL, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/9cdd490e-b192-41b1-8bdd-bfab4b04113e_28f296629cca865e - 副本.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (28, 3, NULL, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/ced6b094-532c-4c12-8c1c-20a9ed7a6bb2_335b2c690e43a8f8 - 副本.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (29, 3, NULL, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/135a0f53-3e3b-476e-8a6e-ee264eae7f6c_a64c5d2d08c1e498 - 副本.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (30, 3, NULL, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/86777e29-eccd-483d-8d62-c0f1faa6c622_919c850652e98031 - 副本.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (31, 3, NULL, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/9501feff-cf63-4741-8ca4-4a796a6cfbce_a83bf5250e14caf2 - 副本.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (32, 3, NULL, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/88e88fd7-dd23-42f0-80e8-ecd4484ee345_a64c5d2d08c1e498.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (33, 3, NULL, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/fc5a3c57-0745-49bf-8027-ab3c78807a16_b5c6b23d01dcdf81.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (34, 3, NULL, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/a3d06117-862f-44ad-8a66-5550a7d93670_d08df10ef411470b.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (35, 3, NULL, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/14fc4455-95b7-43fc-8400-6d939bce92e6_b9840ff8da7762ae.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (36, 3, NULL, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/57c8e0f3-b570-4e20-8af7-c689ae813fd7_d511faab82abb34b.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (37, 4, NULL, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/b836a146-46c7-4d02-8201-f154f36f584f_6a1b2703a9ed8737.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (38, 4, NULL, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/ea46d643-2991-4fa6-8842-501dad257291_a2c208410ae84d1f.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (39, 4, NULL, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/571335f0-73d0-4544-88d1-a9ecc4bc054b_ccd1077b985c7150.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (40, 4, NULL, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/cdd785e2-11df-4cb8-81f6-5c7acd0409c6_b8494bf281991f94.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (41, 4, NULL, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/3ac0996a-850d-48e2-81fd-614b62b1a742_chns28dh2.png', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (42, 4, NULL, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/eca929c4-8608-49f2-80c1-d760a34da35b_hd2fcnwosm.png', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (43, 4, NULL, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/7e9277f5-db02-40f9-8be2-b3f226ae4bef_shkacnalcl.png', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (56, 6, NULL, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2020-10-28/9e750a04-f061-462f-8be0-495fc3251c69_]1O3RF$Q{5QF7{}9C4VS}80.png', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (57, 6, NULL, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2020-10-28/d2302622-4320-4cb2-8d75-5fd73dea37b4_~~(O[EXXL2ZP[O0A3LD6_05.png', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (58, 6, NULL, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2020-10-28/329dd2a1-4399-46f4-8f73-1490c3a554eb_2r4hytkfgfd.png', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (59, 6, NULL, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2020-10-28/d8d22666-eb60-4109-8ca7-d19628ad5109_fwqeftgewagq45 ht.png', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (60, 6, NULL, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2020-10-28/14a9f576-f3fd-4c48-8b37-419fb569afd8_34gv2ytvb3t4qy4.png', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (61, 6, NULL, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2020-10-28/a6509001-80e5-4570-8932-e3a05c6b3453_3fwe.png', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (62, 6, NULL, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2020-10-28/2bca7ab0-4661-478c-8934-43d17a4bbfb6_REYT356U JRHS.png', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (63, 6, NULL, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2020-10-28/2bbf6581-b800-489d-8ef9-e9ad4d7a4a7e_FSFSAFASFAS.png', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (64, 6, NULL, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2020-10-28/37c7912b-cb4f-4621-81d8-cab01d28a340_TQEWTWEDSDG.png', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (65, 6, NULL, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2020-10-28/36969090-ddf7-4ab2-840c-dfb8cb410a23_TEWTWESFD.png', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (66, 6, NULL, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2020-10-28/54bf4fa5-d525-4d9e-82cb-4cb4fa5c8644_t43v26tvg425yq.png', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (67, 6, NULL, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2020-10-28/3a1ac4a3-84b1-4768-8daa-9b403c40be2f_qty43gesdf.png', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (68, 7, NULL, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2020-10-28/4a9391e8-01ee-4ad7-8b27-0fe473a4d766_Snipaste_2020-10-28_13-41-55.png', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (69, 7, NULL, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2020-10-28/5a163313-5934-4cbe-80ed-6cf31f1e81a7_Snipaste_2020-10-28_13-42-41.png', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (70, 7, NULL, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2020-10-28/cd3d3b53-5013-4753-8cd1-f387df164fad_Snipaste_2020-10-28_13-42-54.png', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (71, 7, NULL, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2020-10-28/f2f2f737-3ccb-4346-842b-8a68d5bf2a6c_Snipaste_2020-10-28_13-43-42.png', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (72, 7, NULL, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2020-10-28/ea7c956e-fb3a-4f00-8faa-c014e151ea6d_Snipaste_2020-10-28_13-43-51.png', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (73, 7, NULL, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2020-10-28/abd76a64-139f-4187-84f2-68303242e681_Snipaste_2020-10-28_13-43-18.png', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (74, 7, NULL, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2020-10-28/87c479ca-da4e-4eed-8756-f621ada0b4c3_Snipaste_2020-10-28_13-44-09.png', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (75, 7, NULL, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2020-10-28/635df4b7-f9d6-48e2-8951-3a2213ece168_Snipaste_2020-10-28_13-44-38.png', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (76, 7, NULL, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2020-10-28/489f0eaf-3289-45ea-8cfa-a8f5e1874a59_Snipaste_2020-10-28_13-44-30.png', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (77, 7, NULL, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2020-10-28/168ed1ea-b67a-4077-8fa9-2859208559bb_Snipaste_2020-10-28_13-44-45.png', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (78, 7, NULL, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2020-10-28/1882e3ef-1419-4966-8c24-ee4f5b7edf9a_Snipaste_2020-10-28_13-45-04.png', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (79, 7, NULL, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2020-10-28/db4e2787-2941-4f10-89ba-604e4e497043_Snipaste_2020-10-28_13-43-07.png', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (80, 7, NULL, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2020-10-28/2352aa12-dbde-441a-86c8-0ebe30cd25d1_Snipaste_2020-10-28_13-44-55.png', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (81, 7, NULL, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2020-10-28/f4c7ac96-2130-4483-8140-90566b9d61e5_Snipaste_2020-10-28_13-44-01.png', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (82, 8, NULL, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/8f490a3b-894f-4cf0-8429-c61a5c51364f_3rteewagfvsa.png', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (83, 8, NULL, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/fd5b620c-7dde-4cf2-8ff9-e451ae16b613_8v43u9v93v.png', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (84, 8, NULL, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/eb4e30bc-255b-473c-8c6f-6e4feafdac8e_AWERWARFA.png', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (85, 8, NULL, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/0b9eef68-535e-4beb-825d-3d19aeca3ca7_FASFWASAFEWRT.png', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (86, 8, NULL, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/8080d1a0-41dd-430e-8742-9ba5064b6f08_fgewt3456yb 45.png', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (87, 8, NULL, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/b7a93d66-df4b-45cf-856b-1bae99d35bff_345tgers bdgfgase.png', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (88, 8, NULL, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/344764fe-63b4-4f90-8b86-2890e21842e0_h531qtg4.png', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (89, 8, NULL, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/1f20ab91-d033-4846-8295-4fb74ccef0c2_YYTRTAFSD.png', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (90, 8, NULL, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/7ea762a8-27d7-418f-8cf4-ea5fc795dec5_TEWQQWAFG RGHD.png', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (91, 8, NULL, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/74204123-3709-4c7a-86e8-e6c72a866a53_d9suds8dh8s.png', NULL, NULL);
...
CREATE TABLE `pms_spu_info`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 8 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = 'spu信息' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_spu_info
-- ----------------------------
INSERT INTO `pms_spu_info` VALUES (3, '华为 HUAWEI Mate 30E Pro 5G', '麒麟990E SoC芯片 双4000万徕卡电影影像 全网通手机', 225, 1, 0.1980, 1, '2021-01-10 14:15:14', '2021-01-10 14:15:14');
INSERT INTO `pms_spu_info` VALUES (4, 'Apple iPhone XR (A2108) ', '移动联通电信4G手机 双卡双待', 225, 2, 0.1940, 1, '2021-01-10 14:38:06', '2021-01-10 14:38:06');
INSERT INTO `pms_spu_info` VALUES (6, '【向往的生活同款】小米10青春版 ', '双模5G 骁龙765G 50倍潜望式变焦四摄 8GB+128GB 黑巧风暴游戏手机', 225, 3, 0.1920, 1, '2021-01-10 15:16:04', '2021-01-10 15:16:04');
INSERT INTO `pms_spu_info` VALUES (7, 'vivo X50 5G手机', 'vivo X50 5G手机', 225, 5, 0.1745, 1, '2021-01-10 15:21:08', '2021-01-10 15:21:08');
INSERT INTO `pms_spu_info` VALUES (8, 'OPPO K7 双模5G 骁龙765G', 'OPPO K7 双模5G 骁龙765G', 225, 4, 0.1800, 1, '2021-01-10 15:51:28', '2021-01-10 15:51:28');
...
CREATE TABLE `pms_spu_info_desc`  (
  ...
  `descript` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '商品介绍',
...
-- ----------------------------
INSERT INTO `pms_spu_info_desc` VALUES (3, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/4f01cd65-04c6-43c4-8f26-ea9ba141f516_73366cc235d68202.jpg,https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/fc081b56-cf3e-48c9-8811-7ba93ea440a2_HAUEIMATE30.jpg');
INSERT INTO `pms_spu_info_desc` VALUES (4, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/58a4df20-4b27-460d-8a43-501cb362b579_iphoneXR.jpg');
INSERT INTO `pms_spu_info_desc` VALUES (6, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2020-10-28/af3ba6bc-d648-4cec-85e1-b22e544d3b90_XIAOMI10.jpg');
INSERT INTO `pms_spu_info_desc` VALUES (7, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2020-10-28/5abe5d68-df21-4fc4-8cbb-7b80956cb767_vivo x50.jpg');
INSERT INTO `pms_spu_info_desc` VALUES (8, 'https://vivi-gulimall.oss-cn-hangzhou.aliyuncs.com/2021-01-10/b80e120f-79dd-40c8-8ab2-8e658ecbfead_OPPOK7.jpg');
